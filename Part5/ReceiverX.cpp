...
void ReceiverX::clearCan()
{
	...
	bool clearing = true;
		while(clearing)
		{
			cout<< endl<< endl << "receivercanclled"<< endl<< endl;
			canint = myReadcond(mediumD,&character,1,1,TM_2CHAR,TM_2CHAR);
			if(-1 == canint)
			{
				break;
...
void ReceiverX::purge()
{
	...
	while(purging)
	{
		if( 0 == myReadcond(mediumD,&something,1,1,TM_CHAR,TM_CHAR) )
		{
			return;
		}
	}
