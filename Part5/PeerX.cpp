...
//% Student 1 #: 301316291
//% Student 1 userid (email): sungurea (sungurea@sfu.ca)
//
//% Student Name 2: Jamyl Johnson
//% Student 2 #: 301313059
//% Student 2 userid (email): jamylj(jamylj@sfu.ca)
//
//% Below, edit to list any people who helped you with the code in this file,
//%      or put 'None' if nobody helped (the two of) you.
//
// Helpers: _everybody helped us/me with the assignment (list names or put 'None')__ all of the TA's
//
...
void PeerX::transferCommon(std::shared_ptr<StateMgr> mySM, bool reportInfoParam)
{
	...
	mySM->setDebugLog(nullptr); // this will affect both peers.  Is this okay?... I'm not alright - Josh
	...
	while(mySM->isRunning()) {
		...
		if (now >= absoluteTimeout) {
			...
			if(FD_ISSET( consoleInId, &set ))
			{
				...
				//char inputStr[3];
				int numberBytesRead = PE(myRead(consoleInId, &byteToReceive, LINEMAX_SAFE));
				byteToReceive[numberBytesRead] = '\0'; //why backslash 0 not \n
